...
_POSITIVE: dict[str, float] = {
    ...
    # 社群／散戶用語（多）
    "噴出": 1.2, "噴": 0.9, "起漲": 1.0, "上車": 0.8, "抱緊": 0.7, "嘎空": 1.1,
    "軋空": 1.1, "紅通通": 1.0, "賺爛": 1.2, "航海王": 0.8, "存股": 0.5,
    "抄底": 0.7, "加碼": 0.7, "甜甜價": 0.7, "強勢": 0.8, "發大財": 1.0,
}
...
_NEGATIVE: dict[str, float] = {
    ...
    # 社群／散戶用語（空）
    "畢業": 1.2, "住套房": 1.1, "韭菜": 0.9, "抬轎": 0.8,
    "綠光": 0.9, "腰斬": 1.3, "跳水": 1.1, "水餃股": 1.0, "賠錢": 1.0,
    "下車": 0.7, "停損": 0.8, "認賠": 0.9, "套在": 0.9, "崩盤": 1.4, "雷": 0.8,
}
